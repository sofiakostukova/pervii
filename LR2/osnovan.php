    ...
    <?php  include ('header.php'); ?>
        ...
        <form class="container pt-3 pb-3" action="osnovan.php" method="GET" name="fillter">
            ...
            <div class="price d-flex align-items-center justify-content-center">
                ...
                <input style='width: 400px;' class="form-control" name="name" type="text" placeholder="Название">

                <select style='width: 200px; margin-left: 30px' class="form-select" name="avtors" aria-label="Default select example">
                ...
                <input style='width: 400px; margin-left: 30px' class="form-control" name="description" type="text" placeholder="Описание">
